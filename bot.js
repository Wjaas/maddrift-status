...
exports.start = function(SETUP) {
  ...
  const UpdateEmbed = function() {
    ...
    .setAuthor("Mad Drift Server Status", "https://cdn.discordapp.com/attachments/623566667493933096/662079413680341012/MADDrift.png")
    .setColor('#f54242')
    .setFooter(TICK_N % 2 === 0 ? '⚪ Mad Drift' : '⚫ Mad Drift')
    .setTimestamp(new Date())
    .addField('\n\u200b\nHow can I join the server?','You can join the server by entering the following IP: __144.91.68.184:30120__	 in **Direct Connect** or you can search for **Mad Drift** in the serverlist.\n\u200b\n',false)
    if (STATUS !== undefined)
    {
